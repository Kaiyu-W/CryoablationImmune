...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 29 12:58:16 2022
...
T_2111.obs['IFN_Final'] = adata.obs.IFN_Final
T_2111.obsm['X_umap_3end'] = adata.obsm['X_umap']
sc.pl.umap(T_2111, color='IFN_Final', legend_loc='on data', size=10, legend_fontsize=8)
sc.pl.umap(T_2111, color='IFN_Final', legend_loc='on data', groups=('Tfh_I-IFN','CD8_Tem_I-IFN'), size=10, legend_fontsize=8)
sc.pl.embedding(T_2111, 'X_umap_3end', color='IFN_Final', legend_loc='on data', size=10, legend_fontsize=8)
sc.pl.embedding(T_2111, 'X_umap_3end', color='IFN_Final', legend_loc='on data', groups=('Tfh_I-IFN','CD8_Tem_I-IFN'), size=10, legend_fontsize=8)


ax = sc.pl.umap(T_2111, color='IFN_Final', legend_loc='on data', size=10, 
           legend_fontsize=6, frameon=False, show=False)
ax.title.set_size(10)
plt.show()

ax = sc.pl.embedding(T_2111, 'X_umap_3end', color='IFN_Final', legend_loc='on data', size=10, 
           legend_fontsize=6, frameon=False, show=False)
ax.title.set_size(10)
plt.show()
